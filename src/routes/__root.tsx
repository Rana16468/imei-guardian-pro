...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Lovable Sales Tracker manages phone sales, customer data, and inventory in real-time." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Lovable Sales Tracker manages phone sales, customer data, and inventory in real-time." },
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <header className="h-14 border-b bg-card flex items-center gap-3 px-4 sticky top-0 z-30">
              ...
              <div className="relative flex-1 max-w-md hidden sm:block">
                ...
                <input
                  placeholder="Quick search IMEI, customer, invoice..."
